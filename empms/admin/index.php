  ...
  <section class="login-content">
    ...
    <div class="login-box">
      <form class="login-form" method="post">
        ...
        <?php if ($error) { ?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } else if ($msg) { ?><div style="color:red"><strong>Error</strong>:<?php echo htmlentities($msg); ?> </div><?php } ?>
